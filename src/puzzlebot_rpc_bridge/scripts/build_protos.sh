...
#     RobotState.proto
PATH=$PATH:$HOME/go/bin protoc --proto_path=proto --go_out=proto --go_opt=paths=source_relative \
    proto/RobotState.proto
PATH=$PATH:$HOME/go/bin protoc --proto_path=proto --go-grpc_out=proto --go-grpc_opt=paths=source_relative \
    proto/RobotState.proto
PATH=$PATH:$HOME/go/bin protoc -I proto --grpc-gateway_out proto \
    --grpc-gateway_opt paths=source_relative \
    proto/RobotState.proto
protoc --proto_path=proto --grpc_out=proto proto/RobotState.proto
